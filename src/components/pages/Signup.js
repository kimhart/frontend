        ...
        <div className="signup-page">
          ...
          <div className="form-container">
            <form className="signup-form" onChange={this.handleChange} onSubmit={this.handleSubmit}>
              ...
              <input type="text" placeholder="First Name" ref="firstNameInput" required />
              <input type="text" placeholder="Last Name" ref="lastNameInput" required />
              <input type="text" placeholder="Street Address" ref="streetInput" required />
              <input type="text" placeholder="ZIP code" ref="zipcodeInput" required />
